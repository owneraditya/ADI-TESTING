...
-- ====================================================================
-- MOD FEATURES (from 1.lua) – integrated without bypass duplication
-- ====================================================================
...
_G.InitModMenuTab = function()
    ...
    if not SettingPageDefine.ModMenu then
        ...
        local ModMenuStack = {
            { UI = AliasMap.Title, Text = "MOD SETTINGS" },
            {
                Key = "ModMenu_Aimbot",
            ...
            },
            {
                ...
                GetFunc = function() return (_G.Mod_AimbotStrength or 50) / 100 end,
                SetFunc = function(_, value)
...
-- Initialize mod menu once
pcall(function() _G.InitModMenuTab() end)

print("[MOD] ✅ Full features loaded (Bypass excluded)")
